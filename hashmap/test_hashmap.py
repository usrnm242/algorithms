...
new_load_factor = 0.75

print(f"changing load factor; \ncalling func with setting load factor = {new_load_factor}")

hm.change_load_factor(new_load_factor)  # we can use any value
